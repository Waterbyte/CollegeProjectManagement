...
$user_department=$row["user_department"];
 ...
 $sql2="SELECT * FROM project WHERE project_department='".$user_department."' and project_status=4 or project_status=5 or project_status=9";
...
function StatusCheck($project_status,$row2)
{
    if($project_status==4)
    {
       return "<input name=\"Edit$row2[project_id]\" type=\"submit\" value=\"Approve\"  >";
    }
    else if($project_status==5)
    {
        return "Approved by Project Incharge";
    }
...
function StatusCheckReject($project_status,$row2)
{
    ...
    else if($project_status==9)
    {
        return "Rejected by Project Incharge";
    }
}
