...
<html>
<head>
<title>Completed Project List</title>
...
$user_department=$row["user_department"];
 ...
 $sql2="SELECT * FROM project WHERE project_department='".$user_department."' and project_status=3 or project_status=4 or project_status=8 and project_supervisor='".$user_id."'";
